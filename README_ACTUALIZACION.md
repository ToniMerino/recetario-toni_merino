# Actualización RTM v1.3.0 · Sprint 3.0

## Objetivo
Actualizar de v1.1.0 a v1.3.0 incorporando migración segura de datos locales.
...
4. Commit: `Publicar RTM v1.3.0 - Sprint 3`.
5. Push origin.
...
La primera ejecución de v1.3.0 migra el almacenamiento heredado de v1.1.0 y crea una instantánea del catálogo base para que las siguientes actualizaciones puedan distinguir entre datos base y cambios personales.

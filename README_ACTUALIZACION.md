# Actualización recomendada · v2.1.17
...
## Publicación corregida v2.1.17 (2026-09-10)
...
- Se usa el token de caché `2.1.17-20260910` para forzar la recarga de recursos.
- El manifest y el service worker quedan alineados con v2.1.17.

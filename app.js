...
const CURRENT_DATA_VERSION=window.RTM_DATA_VERSION||"2.1.2";
let adminMode=false;
...
"Pastelería y repostería":["Bizcocho","Tarta","Galleta","Magdalena","Hojaldre dulce","Coca dulce","Vacherin"],
...
"Carnes y aves":["Pollo","Cerdo","Ternera","Cordero","Conejo","Caza","Carne picada","Casquería","Charcutería"],
...
"Legumbres":["Garbanzos","Lentejas","Judías","Otras legumbres"],
...
"Entrantes y aperitivos":["Croqueta","Buñuelo","Ensaladilla","Paté","Aperitivo","Mousse salada","Entrante de verduras y marisco"],
...
"Técnicas y bases culinarias":["Caldo base","Fondo","Cocción","Sofrito","Masa base","Marca para arroces"]
};

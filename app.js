...
function loadRecords(){
  ...
  const merged=base.filter(r=>!deletedIds.has(r.id)).map(r=>{
    ...
    return {...r,...local,vegetarian:local.vegetarian??r.vegetarian,vegan:local.vegan??r.vegan,dietary_note:local.dietary_note??r.dietary_note};
  });
